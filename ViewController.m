...
- (void)viewDidLoad {
    ...
    NSString *origHtml;
    origHtml=[NSString stringWithFormat:@"%@%@：%@",@"abc",[NSString stringWithFormat:@"<img src=\"file://%@\" width=\"30\" height=\"15\"/ style=\"vertical-align:-20%%\">abcccc<img src=\"http://cc.cocimg.com/api/uploads/160927/dcc9a3f21c41a5c8cbcaa9e265d108a2.jpg\" width=\"30\" height=\"15\"/ style=\"vertical-align:-20%%\">",[[NSBundle mainBundle] pathForResource:@"卷轴.png" ofType:nil]],@"aaa"];
